...
# cat_feature = st.selectbox("Select the categorical feature", ["Sex", "Survived", "Embarked"])
# print(cat_feature)
# if cat_feature:
    
#     # fig, ax = plt.subplots(figsize=(10, 7))
#     # sns.countplot(x = cat_feature, data=train_data, ax=ax[0])
#     # st.pyplot()
#     fig = plt.figure(figsize = (10, 5))
#     plt.scatter(train_data["Age"], train_data["Ticket"])
#     plt.ylim(0)
